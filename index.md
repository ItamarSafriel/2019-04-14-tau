...
venue: "21st Century Software and Data Analysis Tools for Physics and Astronomy"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Azalee Bostroem", "Griffin Hosseinzadeh", "Dayla Baron"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
